...
- scenes 配列に全シーン（id, in_sec, out_sec, type="slide", image, broll/ai_video, caption, notes）を含める
- generate_scene_videoでAI動画クリップを生成したシーンは、"broll"ではなく"ai_video": "ai_video/scene_NN.mp4" をscenesに設定する
